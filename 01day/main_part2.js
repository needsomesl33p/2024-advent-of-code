...
function countSimilarityScore(locationId, rightList) {
    var counter = 0;
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var inputs, lines, leftList, rightList, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
